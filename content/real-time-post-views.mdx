...
3.  Navigate to "Database" and click "Create Database".
    <Image
        ...
        src={`/images/blog/real-time-post-views/firebase/step1.png`}
        width={1000}
        height={534}
    />
4.  Start in test mode and click next.
    <Image
        alt={`Create Firebase Database`}
        src={`/images/blog/real-time-post-views/firebase/step2.png`}
        width={1000}
        height={533}
    />
5.  Choose your database location and click done.
    <Image
        alt={`Create Firebase Database`}
        src={`/images/blog/real-time-post-views/firebase/step3.png`}
        width={1000}
        height={532}
    />
6.  In the top left, click on "Project Settings".
    <Image
        alt={`Create Firebase Database`}
        src={`/images/blog/real-time-post-views/firebase/step4.png`}
        width={979}
        height={386}
    />
7.  Navigate to "Service Accounts" tab and click "Generate new private key". Save the `.json` file. You will need this later.
    <Image
        alt={`Create Firebase Database`}
        src={`/images/blog/real-time-post-views/firebase/step5.png`}
        width={1000}
        height={535}
    />
...
<Image
    ...
    src={`/images/blog/real-time-post-views/testing-database.png`}
    width={1000}
    height={562}
/>
...
<Image
    alt={`Blog Post Views`}
    src={`/images/blog/real-time-post-views/blog-post-views.png`}
    width={1000}
    height={599}
/>
...
<Image
    alt={`Database Usage`}
    src={`/images/blog/real-time-post-views/db-usage.png`}
    width={1000}
    height={529}
/>
