...
<Image
    alt={`Redux Growth`}
    src={`/images/blog/react-state-management/redux.png`}
    width={1000}
    height={586}
/>
...
<Image
    alt={`React Context`}
    src={`/images/blog/react-state-management/context.png`}
    width={1000}
    height={572}
/>
...
<Image
    alt={`State Machines`}
    src={`/images/blog/react-state-management/state-machines.gif`}
    width={800}
    height={277}
/>
...
<Image
    alt={`Figma`}
    src={`/images/blog/react-state-management/figma.png`}
    width={1000}
    height={663}
/>
...
<Image
    ...
    src={`/images/blog/react-state-management/immer.png`}
    width={1000}
    height={389}
/>
...
<Image
    ...
    src={`/images/blog/react-state-management/amazon.png`}
    width={1000}
    height={732}
/>
...
<Image
    ...
    src={`/images/blog/react-state-management/nomad.png`}
    width={1000}
    height={676}
/>
    ...
    data={{
        ...
        rows: [
            ...
            [
                ...
                "High",
                "Large",
                "Recoil (or Relay if you use GraphQL)",
            ],
        ],
    }}
/>
