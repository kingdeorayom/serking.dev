...
image: "/images/blog/style-guides-component-libraries-design-systems/banner.jpg"
---
...
<a aria-label="Website Mockup" href="https://refactoringui.com/">
    <Image
        alt={`Website Mockup`}
        src={`/images/blog/style-guides-component-libraries-design-systems/website.png`}
        width={1467}
        height={878}
    />
</a>
...
>
    <Image
        alt={`Style Guide`}
        src={`/images/blog/style-guides-component-libraries-design-systems/style-guide.png`}
        width={1468}
        height={1101}
    />
</a>
...
<a aria-label="Component Library" href="https://eva.design/">
    <Image
        ...
        src={`/images/blog/style-guides-component-libraries-design-systems/components.png`}
        width={1000}
        height={376}
    />
</a>
...
>
    <Image
        alt={`Design System`}
        src={`/images/blog/style-guides-component-libraries-design-systems/design-system.png`}
        width={1400}
        height={900}
    />
</a>
...
<a aria-label="Design Tokens" href="https://www.antforfigma.com/">
    <Image
        alt={`Design Tokens`}
        src={`/images/blog/style-guides-component-libraries-design-systems/design-tokens.png`}
        width={1080}
        height={810}
    />
</a>
...
>
    <Image
        alt={`Icon set`}
        src={`/images/blog/style-guides-component-libraries-design-systems/icons.png`}
        width={800}
        height={600}
    />
</a>
...
>
    <Image
        alt={`Monorepo`}
        src={`/images/blog/style-guides-component-libraries-design-systems/monorepo.png`}
        width={1467}
        height={583}
    />
</a>
...
<a aria-label="Buttons" href="https://eva.design/">
    <Image
        alt={`Buttons`}
        src={`/images/blog/style-guides-component-libraries-design-systems/buttons.png`}
        width={1000}
        height={641}
    />
</a>
