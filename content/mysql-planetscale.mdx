...
-   Export JSON data from my Firebase Realtime Database
    ...
    <Image
        ...
        src={`/images/blog/mysql-planetscale/firebase.png`}
        width={2905 / 2}
        height={1959 / 2}
    />
...
-   Export JSON data from my Redis cluster using `HVALS` and TablePlus
    ...
    <Image
        ...
        src={`/images/blog/mysql-planetscale/redis.png`}
        width={2540 / 2}
        height={1852 / 2}
    />
...
<Image
    ...
    src={`/images/blog/mysql-planetscale/checkly.png`}
    width={1490}
    height={528}
/>
...
<Image
    ...
    src={`/images/blog/mysql-planetscale/checkly-firebase.png`}
    width={2264 / 2}
    height={1076 / 2}
/>
