                        ...
                        <Card>
                            <div className="flex items-center space-x-3">
                                ...
                                <div className="flex flex-col">
                                    <p className="font-medium line-clamp-1 text-sm text-neutral-900 dark:text-neutral-100">
                                        University of Perpetual Help System
                                        Laguna
                                    </p>
                                    <p className=" text-xs text-neutral-900 dark:text-neutral-100 line-clamp-1">
