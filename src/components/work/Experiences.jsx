    ...
    return (
        <>
            <div className="flex flex-col gap-y-6">
                ...
                <p>
                    Over the course of two years, I&apos;ve tackled a variety of
                    challenging projects, primarily focusing on frontend
                    development with React Native for mobile and Next.js for web
                    and backend work with Laravel, REST APIs and MySQL.
                </p>
                <p>
                    ...
                    official website, ensuring it effectively communicates our
                    brand identity and offerings to a diverse audience and if it
                    actually works! Moreover, my involvement in designing
                    primary user interfaces and user experiences for both the
                    primary mobile and web applications has been pivotal.
                </p>
                <p>
                    ...
                    management, API development, and gradually migrating legacy
                    components and codebase to modern frameworks and
                    infrastructure.
                </p>
            </div>
