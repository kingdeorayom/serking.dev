        ...
        <main id='wrapper'>
            ...
            <section id='about'>
                ...
                <section className="gallery">
                    ...
                    <a href={image_1} data-fancybox="gallery"><img src={image_1} className='img-fluid about__gallery__image' alt="About Gallery" /></a>
                    <a href={image_2} data-fancybox="gallery"><img src={image_2} className='img-fluid about__gallery__image' alt="About Gallery" /></a>
                    <a href={image_3} data-fancybox="gallery"><img src={image_3} className='img-fluid about__gallery__image' alt="About Gallery" /></a>
                    <a href={image_4} data-fancybox="gallery"><img src={image_4} className='img-fluid about__gallery__image' alt="About Gallery" /></a>
                    <a href={image_5} data-fancybox="gallery"><img src={image_5} className='img-fluid about__gallery__image' alt="About Gallery" /></a>
                    <a href={image_6} data-fancybox="gallery"><img src={image_6} className='img-fluid about__gallery__image' alt="About Gallery" /></a>
                    <a href={image_7} data-fancybox="gallery"><img src={image_7} className='img-fluid about__gallery__image' alt="About Gallery" /></a>
                    <a href={image_8} data-fancybox="gallery"><img src={image_8} className='img-fluid about__gallery__image' alt="About Gallery" /></a>
                    <a href={image_9} data-fancybox="gallery"><img src={image_9} className='img-fluid about__gallery__image' alt="About Gallery" /></a>
                    <a href={image_10} data-fancybox="gallery"><img src={image_10} className='img-fluid about__gallery__image' alt="About Gallery" /></a>
                    <a href={image_11} data-fancybox="gallery"><img src={image_11} className='img-fluid about__gallery__image' alt="About Gallery" /></a>
                    <a href={image_12} data-fancybox="gallery"><img src={image_12} className='img-fluid about__gallery__image' alt="About Gallery" /></a>
