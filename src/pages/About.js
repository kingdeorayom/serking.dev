    ...
    return (
        <main id='wrapper'>
            ...
            <section id='about'>
                ...
                <h2 className="page__content">Contact me at kingdeorayom@gmail.com or <a href='https://twitter.com/kingdeorayom' target={"_blank"} rel="noreferrer" className="link__text__twitter">Twitter</a>.</h2>
